  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 rounded-full border-2 border-muted-foreground/100 flex items-start justify-center p-2">
          <div className="w-1 h-2 bg-muted-foreground/100 rounded-full" />
        </div>
      </div>
    </section>
  );
